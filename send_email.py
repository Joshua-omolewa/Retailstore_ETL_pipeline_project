...
def send_email():
    ...
    """
    This function is used to send email if the raw data cannot be found in the staging area (input S3 bucket)
    """
    ...
    # Try to send the email. and using error handling with client 
    try:
