...
* EMR : The EMR cluster has hadoop & spark installed and will transform the raw data received from airflow using spark streaming to meet the business requirement  and send the transform data in parquet (hudi) format to the output S3  bucket (ETL process). 
