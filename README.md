...
* EMR : The EMR cluster has hadoop & spark installed and will transform the raw data received from airflow using spark streaming to meet the business requirement  and send the transform data in parquet (hudi) format to the output S3  bucket (ETL process). <img src="https://github.com/Joshua-omolewa/end-2-end_data_pipeline_project/blob/main/img/emr%20runing%20spark%20submit%20job.jpg"  width="100%" height="100%">
