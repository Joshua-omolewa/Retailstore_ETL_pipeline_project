...
if __name__ == "__main__":
    ...
    #STEP 2 CREATING EMPTYDATAFRAMES FOR DIMENSION AND FACT TABLES 


    print("creating dimension and fact tables")

    ##### DIMENSION TABLES #####  
    #issues with MERGE INTO upsert as pyspark does not support upsert, hence hard coding dimension tables


    print("Generating dimension tables dataframe")
